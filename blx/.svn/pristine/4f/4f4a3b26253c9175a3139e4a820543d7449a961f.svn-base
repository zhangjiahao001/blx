						...
						<form action="staff/staffAdd.html" method="post">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">用户增加页面</h3>
								</div>
								<div class="panel-body">
									...
									<br>
									<input type="text" class="form-control" id="userAddressId" name="userAddressId" placeholder="请输入用户地址编号">
									<br>
									<input type="text" class="form-control" id="userHeadPortraitImgId" name="userHeadPortraitImgId" placeholder="请输入用户头像图片编号">
									<br>
									<input type="text" class="form-control" id="userHeadPortraitImgName" name="userHeadPortraitImgName" placeholder="请输入用户头像图片名称">
								</div>
								<div id="tijiao">
