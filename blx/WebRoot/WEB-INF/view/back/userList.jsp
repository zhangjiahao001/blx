							...
							<div style="padding: 100px 100px 10px;">
							    <form class="bs-example bs-example-form" role="form">
							        <div class="input-group-sm">
							            ...
							            <input type="text" class="form-control" name="userName" placeholder="根据用户姓名搜索">
							            <span class="input-group-addon">用户电话</span>
							            <input type="text" class="form-control" name="userPhone" placeholder="根据用户电话搜索">
							        </div>
							    </form>
							</div>
							<div>
							  ...
							  <table class="table table-border table-bordered" align="center">
							    <thead >
							      <tr id="buess">
									...
									<td><strong>用户地址编号</strong></td>
									<td><strong>用户头像图片编号</strong></td>
									<td><strong>用户头像图片名称</strong></td>
								  </tr>
							    </thead>
							    <tbody>
							      <tr id="buess">
									...
									<td>
										<a href="#">&nbsp;&nbsp;&nbsp;&nbsp;删除&nbsp;&nbsp;&nbsp;&nbsp;</a>
										<a href="skip/back/userAdd.html">&nbsp;&nbsp;&nbsp;&nbsp;增加&nbsp;&nbsp;&nbsp;&nbsp;</a>
										<a href="skip/back/userUpdate.html">&nbsp;&nbsp;&nbsp;&nbsp;修改&nbsp;&nbsp;&nbsp;&nbsp;</a>
									</td>										
							      </tr>
							    </tbody>
							  </table>
