							...
							<div style="padding: 100px 100px 10px;">
							    <form class="bs-example bs-example-form" role="form">
							        <div class="input-group-sm">
							            ...
							            <input type="text" class="form-control" name="articleTitle" placeholder="根据您的文章标题搜索">
							            <span class="input-group-addon">副标题</span>
							            <input type="text" class="form-control" name="articleSubTitle" placeholder="根据您的副标题搜索">
							        </div>
							    </form>
							</div>
							<div>
							  ...
							  <table class="table table-border table-bordered" align="center">
							    <thead>
							      <tr id="buess">
							        <td><strong>编号</strong></td>
									 ...
									 <td><strong>副标题</strong></td>
									 <td><strong>文章时间</strong></td>
									 <td><strong>文章内容</strong></td>
									 <td><strong>作者编号</strong></td>
									 <td><strong>图片编号</strong></td>
									 <td><strong>图片路径</strong></td>
							    ...
							    <tbody>
							      <tr id="buess">
									...
									<td>
										<a href="#">&nbsp;&nbsp;&nbsp;&nbsp;删除&nbsp;&nbsp;&nbsp;&nbsp;</a>
										<a href="skip/back/articleAdd.html">&nbsp;&nbsp;&nbsp;&nbsp;增加&nbsp;&nbsp;&nbsp;&nbsp;</a>
										<a href="skip/back/articleUpdate.html">&nbsp;&nbsp;&nbsp;&nbsp;修改&nbsp;&nbsp;&nbsp;&nbsp;</a>
									</td>										
							      </tr>
							    </tbody>
							  </table>
