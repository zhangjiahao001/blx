						...
						<form action="staff/staffAdd.html" method="post">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">文章修改页面</h3>
								</div>
								<div class="panel-body">
									<input type="hidden" class="form-control" id="articleId" name="articleId" placeholder="">
									<input type="text" class="form-control" id="articleTitle" name="articleTitle" placeholder="请输入文章标题">
									<br>
									<input type="text" class="form-control" id="articleSubTitle" name="articleSubTitle" placeholder="请输入副标题">
									<br>
									<input type="date" class="form-control" id="articleDateTime" name="articleDateTime" placeholder="请输入文章时间">
									<br>
									<textarea class="form-control" placeholder="请输入文章内容" rows="4" id="articleContent" name="articleContent"></textarea>
									<br>
									<input type="text" class="form-control" id="articleWriterId" name="articleWriterId" placeholder="请输入作者编号">
									<br>
									<input type="text" class="form-control" id="articleImgId" name="articleImgId" placeholder="请输入图片编号">
									<br>
									<input type="text" class="form-control" id="articleImgUrl" name="articleImgUrl" placeholder="请输入图片路径">
								</div>
								<div id="tijiao">
