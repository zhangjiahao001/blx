						...
						<form action="staff/staffAdd.html" method="post">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">帮助文档修改页面</h3>
								</div>
								<div class="panel-body">
									<input type="hidden" class="form-control" id="textId" name="textId" placeholder="">
									<input type="text" class="form-control" id="textTitle" name="textTitle" placeholder="请输入文本标题">
									<br>
									<input type="text" class="form-control" id="textSubTitle" name="textSubTitle" placeholder="请输入文本副标题">
									<br>
									<input type="text" class="form-control" id="textContent" name="textContent" placeholder="请输入文本内容">
									<br>
									<input type="text" class="form-control" id="textTypeId" name="textTypeId" placeholder="请输入文本类型编号">
									<br>
									<input type="text" class="form-control" id="textTypeName" name="textTypeName" placeholder="请输入文本类型名称">
									<br>
								</div>
								<div id="tijiao">
