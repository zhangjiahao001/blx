...
<html>
  <head>
   ...
   <title>关于我们</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading animate-box">
					<h2>我们的特色</h2>
					<p>是中国企业综合法律服务平台领航者，是专注为中小微企业提供公司注册、财税代理、商标专利、资质认证、专业法律、社保人事六大领域的一站式企业法律服务平台</p>
				</div>
			</div>
			<div class="row">
	...
	<div class="fh5co-cta" style="background-image: url(<%=basePath%>static/web/images/slide_1.jpg);">
	...
	<!-- Stellar -->
	<script src="<%=basePath%>static/web/js/jquery.stellar.min.js"></script>
